...
\begin{itemize}
    \item Si $m = 1$, alors $a^m = a^1 = a$. \textbf{Exemples :}
    \item Si $m = 0$, alors $a^m = a^0 = 1$. \textbf{Exemples :}
    \item Si $m < -1$, alors $a^m = \frac{1}{a^{-m}}$. \textbf{Exemples :}
    \item Si $m \geq 1$, alors $0^m = 0$. \textbf{Exemples :}
    \item Si $m = 0$, alors $0^0$ n'existe pas.
    \item Si $m < -1$, alors $0^m$ n'existe pas. \textbf{Exemples :} $0^{-3}$ ; $0^{-5}$ ; $0^{-10}$ n'existent pas.
\end{itemize}
